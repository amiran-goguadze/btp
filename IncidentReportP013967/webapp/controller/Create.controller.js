sap.ui.define([
	...
	const initialValues = {
		...
		return BaseController.extend("ns.IncidentReportP013967.controller.Create", {
            onInit: function () {
		...
		var data = this.getView()
            ...
            if (data.title != "" && data.description != "") {
				...
				var settings = {
					async: true,
					url: "/nsIncidentReportP013967/Incidents_CF/incident/SafetyIncidents",
					method: "POST",
					headers: {
        ...
        createPicture: function (response) {
			...
			var settings = {
				async: true,
				crossDomain: true,
				url: "/nsIncidentReportP013967/Incidents_CF/incident/IncidentPhotos",
				"method": "POST",
				"timeout": 0,
				"headers": {
					"content-type": "application/json"
